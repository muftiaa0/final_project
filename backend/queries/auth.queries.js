exports.CREATE_AUTH_TABLE = 'CREATE TABLE authentication (auth_id int NOT NULL AUTO_INCREMENT, username varchar(255) UNIQUE, password varchar(255), elevated boolean, PRIMARY KEY (auth_id, password), FOREIGN KEY (username) REFERENCES employee(username))';
